...
public class firstup {
    public static class OurStudentGroup{
        int age;
        static int number;
        String fio;
    }
    ...
    public static void mainstudent(String[] args) {
        OurStudentGroup s1 = new OurStudentGroup();
        s1.age = 10;
        s1.fio = "ABC";
        s1.number = 1122;

        OurStudentGroup s2 = new OurStudentGroup();
        s2.age = 11;
        s2.fio = "BCA";
        s2.number = 1122;
    }
    ...
    public static class Phone {
        ...
        public static void main(String[] args) {
            ...
            myPhone.battery.maxCapacity = 2100;
            myPhone.battery.currentCapacity = 1050;
            myPhone.display = new Display();
            myPhone.display.d = 5.5;
            myPhone.display.matrix = MatrixType.AMOLED;
            myPhone.RAM = 4000;
            myPhone.display.touch = new Touch();
            myPhone.display.touch.manufacturer = "???";



        }

        public static void mainphone01(String[] args) {
        ...
        public static void mainCAT(String[] args) {
            Cat c1 = new Cat();
            c1.age = 4;
            c1.name = "Kot";
        }
        ...
        public static Car searchByPrice(Car[] cars, double price) {
            for (int i = 0; i < cars.length; i++)
        ...
        public static void mainCar(String[] args) {
            ...
            Car car15000 = searchByPrice(garage, 15000);
            showCar(1, car15000);
        }
        ...
        public static void mainsmart(String[] args) {
